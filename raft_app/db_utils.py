...
def get_conn() -> sqlite3.Connection:
    ...
    WAL + busy_timeout: permite leituras e escritas concorrentes sem travar
    (SQLite padrão bloqueia o banco inteiro em cada escrita — problema real
    quando vários operadores usam o app ao mesmo tempo)."""
